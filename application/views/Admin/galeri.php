...
<div class="row p-2">
    <?php foreach ($galeri as $ca) { ?>
        <div class="card col-lg-4">
            <img src="<?= base_url('assets/upload/galeri/' . $ca['foto']) ?>" class="card-img-top">
            <div class="card-body">
                <h5 class="card-title col d-flex justify-content-center"><?= $ca['judul'] ?></h5>
                <a onClick="return confirm('apakah anda yakin ingin menghapus data!...')" class="btn btn-sm btn-danger" href="<?= base_url('Admin/Galeri/hapus/' . $ca['foto']) ?>">
